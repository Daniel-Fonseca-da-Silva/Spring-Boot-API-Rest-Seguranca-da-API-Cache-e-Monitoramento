...
public class TopicosController {
	...
	@GetMapping
	public Page<TopicoDTO> lista(@RequestParam(required = false) String nomeCurso, @RequestParam Integer pagina, @RequestParam Integer qtd, @RequestParam String ordenacao) {
